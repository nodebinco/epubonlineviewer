...
<div class="min-h-screen flex flex-col bg-base-200">
	...
	<!-- Main: content + optional ad slot (right sidebar for future Google Ads) -->
	<div class="flex-1 flex min-h-0 w-full max-w-[1920px] mx-auto overflow-hidden">
		<main
			class="flex-1 min-w-0 min-h-0 flex flex-col pt-14 md:pt-16 {page.url.pathname.startsWith('/reader') ? 'overflow-hidden' : ''}"
		>
			{@render children()}
		</main>
		<!-- Future Google Ads slot (e.g. 300x600 or 160x600). Hidden until ads are added. -->
